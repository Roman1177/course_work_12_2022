...
__published:	// IDE-managed Components
	...
	TButton *Button5;
	TListBox *ListBox_qu_2;
	TListBox *ListBox_qu_1;
	TLabel *Label17;
	TLabel *Label18;
	TEdit *Edit_res_qu_2;
	TLabel *Label19;
	...
	TLabel *Label21;
	TLabel *Label22;
	TListBox *ListBox_qu_4;
	TListBox *ListBox_qu_3;
	TEdit *Edit_res_qu_3;
	TLabel *Label23;
	TLabel *Label24;
	TEdit *Edit_res_qu_4;
	...
	TMenuItem *G1;
	void __fastcall Open4Click(TObject *Sender);
	...
	void __fastcall Edit_qu_1KeyPress(TObject *Sender, System::WideChar &Key);
